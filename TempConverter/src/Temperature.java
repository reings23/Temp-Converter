...
public class Temperature extends JFrame
{
    ...
    public void setComp()
    {
        String arr1[] = {"Celsius","Fahrenheit","Kelvin","Rankine"};
        String arr2[] = {"Celsius","Fahrenheit","Kelvin","Rankine"};
        l1 = new JLabel("To");
        ...
        clr.setBounds(238,200,50,100);
        mi.setBounds(238,350,50,50);
        ...
        clr.addActionListener(new Handler());
        ...
        add(t1); add(t2);
        add(b); add(mi); add(dot); add(clr); add(bs);
        add(n0); add(n1); add(n2); add(n3); add(n4); add(n5); add(n6); add(n7); add(n8); add(n9);
